...
export const mockMultiDayEvents: EventType[] = [
    ...
    },
    {
        ...
        dateFrom: new Date(2022, 6, 15, 19, 0, 0).toString(),
        dateTo: new Date(2022, 6, 16, 23, 0, 0).toString(),
        orderableFrom: new Date(2022, 3, 1).toString(),
        orderableUntil: new Date(2022, 6, 14).toString(),
        timezone: {
