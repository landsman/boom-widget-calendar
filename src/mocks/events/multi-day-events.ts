...
export const mockMultiDayEvents: EventType[] = [
    {
        ...
        dateFrom: new Date(2023, 5, 12, 9, 0, 0),
        dateTo: new Date(2023, 5, 14, 17, 0, 0),
        orderableFrom: new Date(2023, 2, 1),
        orderableUntil: new Date(2023, 5, 11),
        timezone: {
    ...
    },
    {
        ...
        dateFrom: new Date(2022, 6, 15, 19, 0, 0),
        dateTo: new Date(2022, 6, 16, 23, 0, 0),
        orderableFrom: new Date(2022, 3, 1),
        orderableUntil: new Date(2022, 6, 14),
        timezone: {
